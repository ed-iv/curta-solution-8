...
contract SolveTest is Test {
    ...
    function setUp() public {
        vm.createSelectFork(vm.envString("BASE_URL"));        
        ...
        bool verified = murky.verifyProof(root, proof, data[0]); // true!
        assertTrue(verified);
    ...
    // puzzle.generate(msg.sender), _solution)
}
